...
print("segundo denuevo",(now.second))
...
new_date = datetime(2019, 2, 28, 10, 15, 00, 00000)      #Los argumentos serán: Año, Mes, Día, Hora, Minutos, Segundos, Milisegundos.
...
ya sea agregar días, restar años o simplemente realizar comparaciones. 
Con Python todas estas operaciones podremos realizarlas sin ningún problema.
"""
...
en ocasiones necesitaremos ser más explícitos para no dejar espacio a la ambiguuedad, para ello, 
haremos uso del método strftme.
